...
<footer className="text-gray-600 body-font">
  <div className="container px-5 py-4 mx-auto flex items-center sm:items-inline sm:flex-row flex-col">
    ...
    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© Aryan Tiwari —
      <a href="https://twitter.com/knyttneve" classNameName="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">aryan.tiwari13092002@gmail.com</a>
    </p>
