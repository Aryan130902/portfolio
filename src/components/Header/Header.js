        ...
        <section className= {styles.section}>
          <div className= {styles.inner_section}>
            <div className={styles.hero_body}>
              ...
              <h1 className=" title-font  sm:text-4xl font-primaryfont  lg:text-5xl font-bold text-gray-900 " >I'm Aryan 
                <span className={styles.noobda}> Tiwari </span>
              </h1>
              <p className="font-primaryfont font-light py-5 mb-8 leading-relaxed">
              I am a budding software developer and a true tech enthusiast! With a passion for all things tech, I am currently based in Hyderabad and open to opportunities.</p>
            <Headerswitch/>
            </div>
