...
const Card3 = () => {
  return (
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:p-16 xl:p-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center md:-mr-4 rounded-md shadow-lg relative hover:z-10 hover:scale-105">
